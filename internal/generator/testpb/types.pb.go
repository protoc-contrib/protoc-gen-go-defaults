...
const file_internal_generator_testpb_types_proto_rawDesc = "" +
	"\n" +
	"%internal/generator/testpb/types.proto\x12\x05tests\x1a\x17defaults/defaults.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\"\xe8\f\n" +
	"\x05Types\x12\x1e\n" +
	...
	"\bOneOfTwo\x124\n" +
	"\fstring_field\x18\x01 \x01(\tB\x11\x9aI\x0er\fstring_fieldR\vstringField\"B\n" +
	"\n" +
	"OneOfThree\x124\n" +
	"\fstring_field\x18\x01 \x01(\tB\x11\x9aI\x0er\fstring_fieldR\vstringFieldBSZQgithub.com/protoc-contrib/protoc-gen-go-defaults/internal/generator/testpb;testpbb\x06proto3"
