...
func (Test_Type) EnumDescriptor() ([]byte, []int) {
	return file_internal_generator_testpb_test_proto_rawDescGZIP(), []int{0, 0}
}
...
func (TestOptional_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_generator_testpb_test_proto_enumTypes[1].Descriptor()
}

func (TestOptional_Type) Type() protoreflect.EnumType {
	return &file_internal_generator_testpb_test_proto_enumTypes[1]
}
...
func (TestUnexported_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_generator_testpb_test_proto_enumTypes[2].Descriptor()
}

func (TestUnexported_Type) Type() protoreflect.EnumType {
	return &file_internal_generator_testpb_test_proto_enumTypes[2]
}
...
const file_internal_generator_testpb_test_proto_rawDesc = "" +
	...
	"\r_number_fieldB\r\n" +
	"\v_bool_fieldB\r\n" +
	"\v_enum_fieldBLZJgithub.com/protoc-contrib/protoc-gen-go-defaults/internal/generator/testpbb\x06proto3"
...
func file_internal_generator_testpb_test_proto_init() {
	...
	file_internal_generator_testpb_types_proto_init()
